///هذا البوت الاصدار الثاني من بوت السيستم تحت ادارة النمر :
///اخر تحديث 11\5\2020
...
const youtube = new YouTube("AIzaSyCJxl0CqBpbJZkpb8UibJikqp5HGnsQ6Nk"); //تعديل اساسي سوي اي بي اي جديد
const hastebins = require("hastebin-gen");
const getYoutubeID = require("get-youtube-id");
const yt_api_key = "AIzaSyCJxl0CqBpbJZkpb8UibJikqp5HGnsQ6Nk"; ///تعديل اساسي سوي اي بي اي جديد
...
client.on("message", message => {
  if (message.content.startsWith(prefix + "new")) {
    ...
    if (!message.guild.roles.exists(gg => gg.name === "Support Team"))
      return message.channel.send(`لازم تعمل رول اسمها \`Support Team\`.`);
    if (
...
client.on("message", message => {
  if (message.content === prefix + "bot") {
    const bot = new Discord.RichEmbed()
      ...
      .addField("**Bot Owner** :  ", `» <@693902419620266015>`, true) // تعديل اساسي غير الايدي لايدي حسابك
      .setImage("")
...
client.on("message", message => {
  ...
  if (command == "ban") {
    ...
    if (
      ...
      return message.channel.send("ما تقدرش تبند شخص رتبته اعلى منك!");
...
\`${prefix}رابط\` : اكتب رابط بالشات و هيجيلك رابط السيرفر برايفت
\`${prefix}new\` : لصنع تيكيت
\`${prefix}Giveaway\` : لصنع جيف اواي
...
\`${prefix}settings limitsban\` : تحدد العدد الي عايزه لو حد بند  البوت يبنده 
\`${prefix}settings limitskick\` : تحدد العدد الي عايزه لو حد طرد 3 او 4 البوت يبنده 
\`${prefix}settings limitsroleD\` : تحدد العدد الي عايزه لو حد مسح رول 3 او 4 البوت يبنده 
\`${prefix}settings limitsroleC\` : تحدد العدد الي عايزه لو حد صنع روم 3 او 4 البوت يبنده 
\`${prefix}settings limitschannelD\` : تحدد العدد الي عايزه لو حد مسح روم 3 او 4 البوت يبنده 
...
client.on("message", message => {
  if (message.content === "من المطور") {
    message.channel.send("**النمر-EL-Nmr**");
    message.channel.sendFile("");
  }
});

client.on("message", message => {
  if (message.content === "عندي مشكله") {
    message.channel.send("**تواصل مع احد المودريتور او المطورين لحل مشكلتك**");
    message.channel.sendFile("");
  }
});
...
client.on("message", message => {
  if (message.content.startsWith(prefix + "setby")) {
    ...
    client.on("guildMemberAdd", member => {
      ...
      var channel = member.guild.channels.find(gg => gg.name === "log-discord"); //// تعديل اساسي
      if (!channel) return;
  ...
  if (!anti[channel.guild.id + entry.id]) {
    ...
    if (
      ...
      channel.guild.members
        ...
        .catch(e =>
          channel.guild.owner.send(
            `**⇏ | ${entry.username} قام بأنشاء الكثير من الرولات **`
          )
        );
      anti[channel.guild.id + entry.id].actions = "0";
      fs.writeFile("./config.json", JSON.stringify(config, null, 2), function(
...
client.on("message", message => {
  if (message.content.split(" ")[0] === prefix + "رابط") {
    ...
    const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .setDescription(
        "** تم ارسال الرابط على الخاص ، لو موصلكش افتح البرايفت  **"
      )
      .setAuthor(client.user.username, client.user.avatarURL)
      .setAuthor(client.user.username, client.user.avatarURL)
    ...
    if (url.match(/^https?:\/\/(www.youtube.com|youtube.com)\/playlist(.*)$/)) {
      ...
      try {
        ...
        try {
          ...
          console.error(err);
          return msg.channel.send("لم يتم العثور علي اي شئ");
        }
      }
    ...
    async function handleVideo(video, msg, voiceChannel, playlist = false) {
      ...
      if (!serverQueue) {
        ...
        try {
          ...
          return msg.channel.send(`لا استطيع دخول هذه الروم`);
        }
      } else {
...
//// هذا البوت من صنع و تطوير النمر